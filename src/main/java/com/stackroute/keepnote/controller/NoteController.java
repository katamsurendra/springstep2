...
public class NoteController {
	...
	public String addNote(ModelMap modelMap, @ModelAttribute("note") Note note) {
	...
	public String updateNote(ModelMap modelMap, @RequestParam int noteId, @RequestParam String noteTitle,
